					...
					<div class="login-form bg-light mt-4 p-4">
						<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="row g-3">
							...
							<div class="col-12">
								...
								<input type="password" name="clave2" class="form-control" placeholder="Contraseña">
							</div>
							<div class="col-12">
								<button type="submit" class="btn btn-dark float-end" name="registrar">Registrarse</button>
							</div>
						</form>
						<hr class="mt-4">
						<div class="col-12">
							<p class="text-center mb-0">Inicia sesion <a href="index.php">Volver</a></p>
						</div>
					</div>
				</div>
			</div>
